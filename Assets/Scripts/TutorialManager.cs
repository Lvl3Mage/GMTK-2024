...
public class TutorialManager : MonoBehaviour
{
	...
	IEnumerator Tutorial(){
		...
		notifs.AddNotification("Alright! Time to plant your first plant! Try planting it next to water. You can rotate the plant with the scroll wheel if you press down shift.",  () => plantSpawned);
		...
		notifs.AddNotification("Alright one last thing. Be careful where you grow you plants! If they intersect both plants will die. If a plant loses access to water it will also die.", () => gridExpanded);
